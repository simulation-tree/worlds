...
namespace Worlds
{
    ...
    public readonly struct Entity<C1, C2, C3, C4, C5, C6> : IEntity, IEquatable<Entity<C1, C2, C3, C4, C5, C6>> where C1 : unmanaged where C2 : unmanaged where C3 : unmanaged where C4 : unmanaged where C5 : unmanaged where C6 : unmanaged
    {
        private readonly Entity entity;

        readonly World IEntity.World => entity.world;
        readonly uint IEntity.Value => entity.value;
        readonly Definition IEntity.Definition => new(ComponentType.GetBitSet<C1, C2, C3, C4, C5, C6>(), default);
        ...
        {
            entity = new(world, world.CreateEntity(default(C1), default(C2), default(C3), default(C4), default(C5), default(C6)));
        }

        public Entity(World world, C1 c1, C2 c2, C3 c3, C4 c4, C5 c5, C6 c6)
        {
            entity = new(world, world.CreateEntity(c1, c2, c3, c4, c5, c6));
        }
        ...
        {
            return obj is Entity<C1, C2, C3, C4, C5, C6> other && Equals(other);
        }

        public readonly bool Equals(Entity<C1, C2, C3, C4, C5, C6> other)
        {
            return entity.Equals(other.entity);
        }

        public static bool operator ==(Entity<C1, C2, C3, C4, C5, C6> left, Entity<C1, C2, C3, C4, C5, C6> right)
        {
        ...
        public static implicit operator Entity(Entity<C1, C2, C3, C4, C5, C6> entity)
        {
        ...
        internal class DebugView
        {
            ...
            public DebugView(Entity<C1, C2, C3, C4, C5, C6> entity)
            {
