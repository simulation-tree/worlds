...
namespace Worlds
{
    public readonly struct ComponentQuery<C1, C2, C3, C4, C5> where C1 : unmanaged where C2 : unmanaged where C3 : unmanaged where C4 : unmanaged where C5 : unmanaged
    {
        ...
        {
            componentTypes = world.Schema.GetComponents<C1, C2, C3, C4, C5>();
