...
namespace Worlds
{
    ...
    public unsafe ref struct ComponentQuery<C1, C2, C3, C4, C5, C6, C7, C8, C9, C10, C11, C12, C13, C14, C15, C16> where C1 : unmanaged where C2 : unmanaged where C3 : unmanaged where C4 : unmanaged where C5 : unmanaged where C6 : unmanaged where C7 : unmanaged where C8 : unmanaged where C9 : unmanaged where C10 : unmanaged where C11 : unmanaged where C12 : unmanaged where C13 : unmanaged where C14 : unmanaged where C15 : unmanaged where C16 : unmanaged
    {
        ...
        public ref struct Enumerator
        {
            ...
            private readonly ComponentQuery<C1, C2, C3, C4, C5, C6, C7, C8, C9, C10, C11, C12, C13, C14, C15, C16> query;
            ...
            private readonly uint componentOffset13;
            private readonly uint componentOffset14;
            private readonly uint componentOffset15;
            private readonly uint componentOffset16;
            private int version;
            ...
            public readonly Chunk.Entity<C1, C2, C3, C4, C5, C6, C7, C8, C9, C10, C11, C12, C13, C14, C15, C16> Current
            {
                get
                {
                    ...
                    ref C14 component14 = ref componentRow.Read<C14>(componentOffset14);
                    ref C15 component15 = ref componentRow.Read<C15>(componentOffset15);
                    ref C16 component16 = ref componentRow.Read<C16>(componentOffset16);
                    return new(entity, ref component1, ref component2, ref component3, ref component4, ref component5, ref component6, ref component7, ref component8, ref component9, ref component10, ref component11, ref component12, ref component13, ref component14, ref component15, ref component16);
                }
            }
            ...
            internal unsafe Enumerator(ComponentQuery<C1, C2, C3, C4, C5, C6, C7, C8, C9, C10, C11, C12, C13, C14, C15, C16> query)
            {
                ...
                if (chunkCount > 0)
                {
                    ...
                    componentOffset6 = schema.schema->componentOffsets[schema.GetComponentType<C6>()];
                    componentOffset7 = schema.schema->componentOffsets[schema.GetComponentType<C7>()];
                    componentOffset8 = schema.schema->componentOffsets[schema.GetComponentType<C8>()];
                    componentOffset9 = schema.schema->componentOffsets[schema.GetComponentType<C9>()];
                    componentOffset10 = schema.schema->componentOffsets[schema.GetComponentType<C10>()];
                    componentOffset11 = schema.schema->componentOffsets[schema.GetComponentType<C11>()];
                    componentOffset12 = schema.schema->componentOffsets[schema.GetComponentType<C12>()];
                    componentOffset13 = schema.schema->componentOffsets[schema.GetComponentType<C13>()];
                    componentOffset14 = schema.schema->componentOffsets[schema.GetComponentType<C14>()];
                    componentOffset15 = schema.schema->componentOffsets[schema.GetComponentType<C15>()];
                    componentOffset16 = schema.schema->componentOffsets[schema.GetComponentType<C16>()];
                }
                else
                {
                    entities = default;
