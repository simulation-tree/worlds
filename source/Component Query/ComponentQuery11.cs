...
namespace Worlds
{
    public struct ComponentQuery<C1, C2, C3, C4, C5, C6, C7, C8, C9, C10, C11> where C1 : unmanaged where C2 : unmanaged where C3 : unmanaged where C4 : unmanaged where C5 : unmanaged where C6 : unmanaged where C7 : unmanaged where C8 : unmanaged where C9 : unmanaged where C10 : unmanaged where C11 : unmanaged
    {
        ...
        {
            includeComponents = world.Schema.GetComponents<C1, C2, C3, C4, C5, C6, C7, C8, C9, C10, C11>();
            this.world = world;
        }
        ...
        public ComponentQuery<C1, C2, C3, C4, C5, C6, C7, C8, C9, C10, C11> IncludeArray<T>() where T : unmanaged
        {
            includeArrayElements |= world.Schema.GetArrayElement<T>();
            return this;
        }

        public ComponentQuery<C1, C2, C3, C4, C5, C6, C7, C8, C9, C10, C11> IncludeArrays<T1, T2>() where T1 : unmanaged where T2 : unmanaged
        {
            includeArrayElements |= world.Schema.GetArrayElements<T1, T2>();
            return this;
        }

        public ComponentQuery<C1, C2, C3, C4, C5, C6, C7, C8, C9, C10, C11> IncludeArrays<T1, T2, T3>() where T1 : unmanaged where T2 : unmanaged where T3 : unmanaged
        {
            includeArrayElements |= world.Schema.GetArrayElements<T1, T2, T3>();
            return this;
        }

        public ComponentQuery<C1, C2, C3, C4, C5, C6, C7, C8, C9, C10, C11> IncludeArrays<T1, T2, T3, T4>() where T1 : unmanaged where T2 : unmanaged where T3 : unmanaged where T4 : unmanaged
        {
            includeArrayElements |= world.Schema.GetArrayElements<T1, T2, T3, T4>();
            return this;
        }

        public ComponentQuery<C1, C2, C3, C4, C5, C6, C7, C8, C9, C10, C11> IncludeArrays<T1, T2, T3, T4, T5>() where T1 : unmanaged where T2 : unmanaged where T3 : unmanaged where T4 : unmanaged where T5 : unmanaged
        {
            includeArrayElements |= world.Schema.GetArrayElements<T1, T2, T3, T4, T5>();
            return this;
        }

        public ComponentQuery<C1, C2, C3, C4, C5, C6, C7, C8, C9, C10, C11> IncludeArrays<T1, T2, T3, T4, T5, T6>() where T1 : unmanaged where T2 : unmanaged where T3 : unmanaged where T4 : unmanaged where T5 : unmanaged where T6 : unmanaged
        {
            includeArrayElements |= world.Schema.GetArrayElements<T1, T2, T3, T4, T5, T6>();
            return this;
        }

        public ComponentQuery<C1, C2, C3, C4, C5, C6, C7, C8, C9, C10, C11> IncludeArrays<T1, T2, T3, T4, T5, T6, T7>() where T1 : unmanaged where T2 : unmanaged where T3 : unmanaged where T4 : unmanaged where T5 : unmanaged where T6 : unmanaged where T7 : unmanaged
        {
            includeArrayElements |= world.Schema.GetArrayElements<T1, T2, T3, T4, T5, T6, T7>();
            return this;
        }

        public ComponentQuery<C1, C2, C3, C4, C5, C6, C7, C8, C9, C10, C11> IncludeArrays<T1, T2, T3, T4, T5, T6, T7, T8>() where T1 : unmanaged where T2 : unmanaged where T3 : unmanaged where T4 : unmanaged where T5 : unmanaged where T6 : unmanaged where T7 : unmanaged where T8 : unmanaged
        {
            includeArrayElements |= world.Schema.GetArrayElements<T1, T2, T3, T4, T5, T6, T7, T8>();
            return this;
        }

        public ComponentQuery<C1, C2, C3, C4, C5, C6, C7, C8, C9, C10, C11> IncludeArrays<T1, T2, T3, T4, T5, T6, T7, T8, T9>() where T1 : unmanaged where T2 : unmanaged where T3 : unmanaged where T4 : unmanaged where T5 : unmanaged where T6 : unmanaged where T7 : unmanaged where T8 : unmanaged where T9 : unmanaged
        {
            includeArrayElements |= world.Schema.GetArrayElements<T1, T2, T3, T4, T5, T6, T7, T8, T9>();
            return this;
        }

        public ComponentQuery<C1, C2, C3, C4, C5, C6, C7, C8, C9, C10, C11> IncludeArrays<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>() where T1 : unmanaged where T2 : unmanaged where T3 : unmanaged where T4 : unmanaged where T5 : unmanaged where T6 : unmanaged where T7 : unmanaged where T8 : unmanaged where T9 : unmanaged where T10 : unmanaged
        {
            includeArrayElements |= world.Schema.GetArrayElements<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>();
            return this;
        }

        public ComponentQuery<C1, C2, C3, C4, C5, C6, C7, C8, C9, C10, C11> IncludeArrays<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>() where T1 : unmanaged where T2 : unmanaged where T3 : unmanaged where T4 : unmanaged where T5 : unmanaged where T6 : unmanaged where T7 : unmanaged where T8 : unmanaged where T9 : unmanaged where T10 : unmanaged where T11 : unmanaged
        {
            includeArrayElements |= world.Schema.GetArrayElements<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>();
            return this;
        }

        public ComponentQuery<C1, C2, C3, C4, C5, C6, C7, C8, C9, C10, C11> IncludeArrays<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>() where T1 : unmanaged where T2 : unmanaged where T3 : unmanaged where T4 : unmanaged where T5 : unmanaged where T6 : unmanaged where T7 : unmanaged where T8 : unmanaged where T9 : unmanaged where T10 : unmanaged where T11 : unmanaged where T12 : unmanaged
        {
            includeArrayElements |= world.Schema.GetArrayElements<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>();
            return this;
        }

        public ComponentQuery<C1, C2, C3, C4, C5, C6, C7, C8, C9, C10, C11> IncludeTag<T>() where T : unmanaged
        {
            includeTags |= world.Schema.GetTag<T>();
            return this;
        }

        public ComponentQuery<C1, C2, C3, C4, C5, C6, C7, C8, C9, C10, C11> IncludeTags<T1, T2>() where T1 : unmanaged where T2 : unmanaged
        {
            includeTags |= world.Schema.GetTags<T1, T2>();
            return this;
        }

        public ComponentQuery<C1, C2, C3, C4, C5, C6, C7, C8, C9, C10, C11> IncludeTags<T1, T2, T3>() where T1 : unmanaged where T2 : unmanaged where T3 : unmanaged
        {
            includeTags |= world.Schema.GetTags<T1, T2, T3>();
            return this;
        }

        public ComponentQuery<C1, C2, C3, C4, C5, C6, C7, C8, C9, C10, C11> IncludeTags<T1, T2, T3, T4>() where T1 : unmanaged where T2 : unmanaged where T3 : unmanaged where T4 : unmanaged
        {
            includeTags |= world.Schema.GetTags<T1, T2, T3, T4>();
            return this;
        }

        public ComponentQuery<C1, C2, C3, C4, C5, C6, C7, C8, C9, C10, C11> IncludeTags<T1, T2, T3, T4, T5>() where T1 : unmanaged where T2 : unmanaged where T3 : unmanaged where T4 : unmanaged where T5 : unmanaged
        {
            includeTags |= world.Schema.GetTags<T1, T2, T3, T4, T5>();
            return this;
        }

        public ComponentQuery<C1, C2, C3, C4, C5, C6, C7, C8, C9, C10, C11> IncludeTags<T1, T2, T3, T4, T5, T6>() where T1 : unmanaged where T2 : unmanaged where T3 : unmanaged where T4 : unmanaged where T5 : unmanaged where T6 : unmanaged
        {
            includeTags |= world.Schema.GetTags<T1, T2, T3, T4, T5, T6>();
            return this;
        }

        public ComponentQuery<C1, C2, C3, C4, C5, C6, C7, C8, C9, C10, C11> IncludeTags<T1, T2, T3, T4, T5, T6, T7>() where T1 : unmanaged where T2 : unmanaged where T3 : unmanaged where T4 : unmanaged where T5 : unmanaged where T6 : unmanaged where T7 : unmanaged
        {
            includeTags |= world.Schema.GetTags<T1, T2, T3, T4, T5, T6, T7>();
            return this;
        }

        public ComponentQuery<C1, C2, C3, C4, C5, C6, C7, C8, C9, C10, C11> IncludeTags<T1, T2, T3, T4, T5, T6, T7, T8>() where T1 : unmanaged where T2 : unmanaged where T3 : unmanaged where T4 : unmanaged where T5 : unmanaged where T6 : unmanaged where T7 : unmanaged where T8 : unmanaged
        {
            includeTags |= world.Schema.GetTags<T1, T2, T3, T4, T5, T6, T7, T8>();
            return this;
        }

        public ComponentQuery<C1, C2, C3, C4, C5, C6, C7, C8, C9, C10, C11> IncludeTags<T1, T2, T3, T4, T5, T6, T7, T8, T9>() where T1 : unmanaged where T2 : unmanaged where T3 : unmanaged where T4 : unmanaged where T5 : unmanaged where T6 : unmanaged where T7 : unmanaged where T8 : unmanaged where T9 : unmanaged
        {
            includeTags |= world.Schema.GetTags<T1, T2, T3, T4, T5, T6, T7, T8, T9>();
            return this;
        }

        public ComponentQuery<C1, C2, C3, C4, C5, C6, C7, C8, C9, C10, C11> IncludeTags<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>() where T1 : unmanaged where T2 : unmanaged where T3 : unmanaged where T4 : unmanaged where T5 : unmanaged where T6 : unmanaged where T7 : unmanaged where T8 : unmanaged where T9 : unmanaged where T10 : unmanaged
        {
            includeTags |= world.Schema.GetTags<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>();
            return this;
        }

        public ComponentQuery<C1, C2, C3, C4, C5, C6, C7, C8, C9, C10, C11> IncludeTags<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>() where T1 : unmanaged where T2 : unmanaged where T3 : unmanaged where T4 : unmanaged where T5 : unmanaged where T6 : unmanaged where T7 : unmanaged where T8 : unmanaged where T9 : unmanaged where T10 : unmanaged where T11 : unmanaged
        {
            includeTags |= world.Schema.GetTags<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>();
            return this;
        }

        public ComponentQuery<C1, C2, C3, C4, C5, C6, C7, C8, C9, C10, C11> IncludeTags<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>() where T1 : unmanaged where T2 : unmanaged where T3 : unmanaged where T4 : unmanaged where T5 : unmanaged where T6 : unmanaged where T7 : unmanaged where T8 : unmanaged where T9 : unmanaged where T10 : unmanaged where T11 : unmanaged where T12 : unmanaged
        {
        ...
        public ComponentQuery<C1, C2, C3, C4, C5, C6, C7, C8, C9, C10, C11> ExcludeArrayElement<T1>() where T1 : unmanaged
        {
            exclude.AddArrayElementType<T1>(world.Schema);
            return this;
        }

        public ComponentQuery<C1, C2, C3, C4, C5, C6, C7, C8, C9, C10, C11> ExcludeArrayElements<T1, T2>() where T1 : unmanaged where T2 : unmanaged
        {
            exclude.AddArrayElementTypes<T1, T2>(world.Schema);
            return this;
        }

        public ComponentQuery<C1, C2, C3, C4, C5, C6, C7, C8, C9, C10, C11> ExcludeArrayElements<T1, T2, T3>() where T1 : unmanaged where T2 : unmanaged where T3 : unmanaged
        {
            exclude.AddArrayElementTypes<T1, T2, T3>(world.Schema);
            return this;
        }

        public ComponentQuery<C1, C2, C3, C4, C5, C6, C7, C8, C9, C10, C11> ExcludeArrayElements<T1, T2, T3, T4>() where T1 : unmanaged where T2 : unmanaged where T3 : unmanaged where T4 : unmanaged
        {
            exclude.AddArrayElementTypes<T1, T2, T3, T4>(world.Schema);
            return this;
        }

        public ComponentQuery<C1, C2, C3, C4, C5, C6, C7, C8, C9, C10, C11> ExcludeArrayElements<T1, T2, T3, T4, T5>() where T1 : unmanaged where T2 : unmanaged where T3 : unmanaged where T4 : unmanaged where T5 : unmanaged
        {
            exclude.AddArrayElementTypes<T1, T2, T3, T4, T5>(world.Schema);
            return this;
        }

        public ComponentQuery<C1, C2, C3, C4, C5, C6, C7, C8, C9, C10, C11> ExcludeArrayElements<T1, T2, T3, T4, T5, T6>() where T1 : unmanaged where T2 : unmanaged where T3 : unmanaged where T4 : unmanaged where T5 : unmanaged where T6 : unmanaged
        {
            exclude.AddArrayElementTypes<T1, T2, T3, T4, T5, T6>(world.Schema);
            return this;
        }

        public ComponentQuery<C1, C2, C3, C4, C5, C6, C7, C8, C9, C10, C11> ExcludeArrayElements<T1, T2, T3, T4, T5, T6, T7>() where T1 : unmanaged where T2 : unmanaged where T3 : unmanaged where T4 : unmanaged where T5 : unmanaged where T6 : unmanaged where T7 : unmanaged
        {
            exclude.AddArrayElementTypes<T1, T2, T3, T4, T5, T6, T7>(world.Schema);
            return this;
        }

        public ComponentQuery<C1, C2, C3, C4, C5, C6, C7, C8, C9, C10, C11> ExcludeArrayElements<T1, T2, T3, T4, T5, T6, T7, T8>() where T1 : unmanaged where T2 : unmanaged where T3 : unmanaged where T4 : unmanaged where T5 : unmanaged where T6 : unmanaged where T7 : unmanaged where T8 : unmanaged
        {
            exclude.AddArrayElementTypes<T1, T2, T3, T4, T5, T6, T7, T8>(world.Schema);
            return this;
        }

        public ComponentQuery<C1, C2, C3, C4, C5, C6, C7, C8, C9, C10, C11> ExcludeArrayElements<T1, T2, T3, T4, T5, T6, T7, T8, T9>() where T1 : unmanaged where T2 : unmanaged where T3 : unmanaged where T4 : unmanaged where T5 : unmanaged where T6 : unmanaged where T7 : unmanaged where T8 : unmanaged where T9 : unmanaged
        {
            exclude.AddArrayElementTypes<T1, T2, T3, T4, T5, T6, T7, T8, T9>(world.Schema);
            return this;
        }

        public ComponentQuery<C1, C2, C3, C4, C5, C6, C7, C8, C9, C10, C11> ExcludeArrayElements<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>() where T1 : unmanaged where T2 : unmanaged where T3 : unmanaged where T4 : unmanaged where T5 : unmanaged where T6 : unmanaged where T7 : unmanaged where T8 : unmanaged where T9 : unmanaged where T10 : unmanaged
        {
            exclude.AddArrayElementTypes<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>(world.Schema);
            return this;
        }

        public ComponentQuery<C1, C2, C3, C4, C5, C6, C7, C8, C9, C10, C11> ExcludeArrayElements<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>() where T1 : unmanaged where T2 : unmanaged where T3 : unmanaged where T4 : unmanaged where T5 : unmanaged where T6 : unmanaged where T7 : unmanaged where T8 : unmanaged where T9 : unmanaged where T10 : unmanaged where T11 : unmanaged
        {
            exclude.AddArrayElementTypes<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>(world.Schema);
            return this;
        }

        public ComponentQuery<C1, C2, C3, C4, C5, C6, C7, C8, C9, C10, C11> ExcludeArrayElements<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>() where T1 : unmanaged where T2 : unmanaged where T3 : unmanaged where T4 : unmanaged where T5 : unmanaged where T6 : unmanaged where T7 : unmanaged where T8 : unmanaged where T9 : unmanaged where T10 : unmanaged where T11 : unmanaged where T12 : unmanaged
        {
        ...
        public unsafe ref struct Enumerator
        {
            ...
            /// Current result.
            /// </summary>
            public readonly Chunk.Entity<C1, C2, C3, C4, C5, C6, C7, C8, C9, C10, C11> Current => new(entities[entityIndex - 1], ref span1[entityIndex - 1], ref span2[entityIndex - 1], ref span3[entityIndex - 1], ref span4[entityIndex - 1], ref span5[entityIndex - 1], ref span6[entityIndex - 1], ref span7[entityIndex - 1], ref span8[entityIndex - 1], ref span9[entityIndex - 1], ref span10[entityIndex - 1], ref span11[entityIndex - 1]);
