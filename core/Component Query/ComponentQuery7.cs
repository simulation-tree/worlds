...
namespace Worlds
{
    ...
    /// </summary>
    [SkipLocalsInit]
    public unsafe ref struct ComponentQuery<C1, C2, C3, C4, C5, C6, C7> where C1 : unmanaged where C2 : unmanaged where C3 : unmanaged where C4 : unmanaged where C5 : unmanaged where C6 : unmanaged where C7 : unmanaged
    {
        ...
        public ref struct Enumerator
        {
            ...
            public readonly Chunk.Entity<C1, C2, C3, C4, C5, C6, C7> Current
            {
                get
                {
                    ...
                    return new(entity, ref component1, ref component2, ref component3, ref component4, ref component5, ref component6, ref component7);
                }
            }
