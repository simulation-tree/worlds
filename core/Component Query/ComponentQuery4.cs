...
namespace Worlds
{
    ...
    /// </summary>
    [SkipLocalsInit]
    public unsafe ref struct ComponentQuery<C1, C2, C3, C4> where C1 : unmanaged where C2 : unmanaged where C3 : unmanaged where C4 : unmanaged
    {
        ...
        public ref struct Enumerator
        {
            ...
            public readonly Chunk.Entity<C1, C2, C3, C4> Current
            {
                get
                {
                    ...
                    return new(entity, ref component1, ref component2, ref component3, ref component4);
                }
            }
