...
namespace Worlds
{
    public struct ComponentQuery<C1, C2, C3, C4, C5, C6, C7> where C1 : unmanaged where C2 : unmanaged where C3 : unmanaged where C4 : unmanaged where C5 : unmanaged where C6 : unmanaged where C7 : unmanaged
    {
        ...
        public unsafe ref struct Enumerator
        {
            ...
            /// Current result.
            /// </summary>
            public readonly Chunk.Entity<C1, C2, C3, C4, C5, C6, C7> Current => Chunk.Implementation.GetEntity<C1, C2, C3, C4, C5, C6, C7>(chunk, entityIndex - 1, c1, c2, c3, c4, c5, c6, c7);
