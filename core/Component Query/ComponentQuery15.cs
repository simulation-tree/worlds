        ...
        public ref struct Enumerator
        {
            ...
            internal unsafe Enumerator(ComponentQuery<C1, C2, C3, C4, C5, C6, C7, C8, C9, C10, C11, C12, C13, C14, C15> query)
            {
                ...
                if (chunkCount > 0)
                {
                    ...
                    componentOffset4 = schema.componentOffsets[schema.GetComponentType<C4>()];
                    componentOffset5 = schema.componentOffsets[schema.GetComponentType<C5>()];
                    componentOffset6 = schema.componentOffsets[schema.GetComponentType<C6>()];
                    componentOffset7 = schema.componentOffsets[schema.GetComponentType<C7>()];
                    componentOffset8 = schema.componentOffsets[schema.GetComponentType<C8>()];
                    componentOffset9 = schema.componentOffsets[schema.GetComponentType<C9>()];
                    componentOffset10 = schema.componentOffsets[schema.GetComponentType<C10>()];
                    componentOffset11 = schema.componentOffsets[schema.GetComponentType<C11>()];
                    componentOffset12 = schema.componentOffsets[schema.GetComponentType<C12>()];
                    componentOffset13 = schema.componentOffsets[schema.GetComponentType<C13>()];
                    componentOffset14 = schema.componentOffsets[schema.GetComponentType<C14>()];
                    componentOffset15 = schema.componentOffsets[schema.GetComponentType<C15>()];
                }
                else
                {
                    entities = default;
